...
# jazzmin
JAZZMIN_SETTINGS = {
    "site_title": "Нурзаман",  # Заголовок сайта
    "site_header": "Нурзаман",  # Заголовок на экране входа
    "site_brand": "Администрация Нурзаман",  # Выходит на сайте вместо Django-admin.(Администрирование сайта)
    "welcome_sign": "Добро пожаловать в Нурзаман!",  # Приветственный текст на экране входа
